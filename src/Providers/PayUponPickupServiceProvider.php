...
class PayUponPickupServiceProvider extends ServiceProvider
{
     ...
     */
    public function boot( PayUponPickupHelper $paymentHelper, PaymentMethodContainer $payContainer, Dispatcher $eventDispatcher )
    {
        ...
        $eventDispatcher->listen( GetPaymentMethodContent::class, function( GetPaymentMethodContent $event ) use ( $paymentHelper ) {
